...
export function GradientLine2({ className }: { className?: ClassValue }) {
  return (
    <div
      className={cn("w-full relative mx-auto", className)}
    ...
    >
      ...
      <div className="absolute left-1/2 top-0 -translate-x-1/2 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-[3px] w-1/4 blur-sm" />
